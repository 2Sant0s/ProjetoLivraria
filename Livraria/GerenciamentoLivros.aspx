...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" ColCount="2" Width="100%" Theme="Office365">
        <Items>
            <dx:LayoutItem Caption="Título:" RequiredMarkDisplayMode="Required">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer>
                        <dx:ASPxTextBox ID="txbCadastroTituloLivro" runat="server" Width="100%"></dx:ASPxTextBox>
            ...
            <dx:LayoutItem Caption="Editora:" RequiredMarkDisplayMode="Required">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer>
                        <dx:ASPxComboBox ID="cbCadastroEditoraLivro" runat="server" Width="100%"></dx:ASPxComboBox>
                    </dx:LayoutItemNestedControlContainer>
                </LayoutItemNestedControlCollection>
            </dx:LayoutItem>
            <dx:LayoutItem Caption="Tipo de Livro:" RequiredMarkDisplayMode="Required">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer>
                        <dx:ASPxComboBox ID="cbCadastroTipoLivro" runat="server" Width="100%"></dx:ASPxComboBox>
                    </dx:LayoutItemNestedControlContainer>
                </LayoutItemNestedControlCollection>
            </dx:LayoutItem>
            <dx:LayoutItem Caption="Preço:" RequiredMarkDisplayMode="Required">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer>
                        <dx:ASPxSpinEdit ID="seCasdastroPrecoLivro" runat="server" MinValue="0" NumberType="Float" Width="100%"></dx:ASPxSpinEdit>
                    </dx:LayoutItemNestedControlContainer>
                </LayoutItemNestedControlCollection>
            </dx:LayoutItem>
            <dx:LayoutItem Caption="Royalty (%):" RequiredMarkDisplayMode="Required">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer>
                        <dx:ASPxSpinEdit ID="seCadastroRoyaltyLivro" runat="server" MinValue="0" MaxValue="100" NumberType="Integer" Width="100%"></dx:ASPxSpinEdit>
                    </dx:LayoutItemNestedControlContainer>
                </LayoutItemNestedControlCollection>
            </dx:LayoutItem>
            <dx:LayoutItem Caption="Edição:" RequiredMarkDisplayMode="Required">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer>
                        <dx:ASPxSpinEdit ID="seCadastroEdicaoLivro" runat="server" MinValue="1" MaxValue="100" NumberType="Integer" Width="100%"></dx:ASPxSpinEdit>
                    </dx:LayoutItemNestedControlContainer>
                </LayoutItemNestedControlCollection>
            </dx:LayoutItem>
            <dx:LayoutItem Caption="Resumo:" RequiredMarkDisplayMode="Required" ColSpan="2">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer>
                        <dx:ASPxMemo ID="txbCadastroResumoLivro" runat="server" Width="100%" Rows="4"></dx:ASPxMemo>
                    </dx:LayoutItemNestedControlContainer>
                </LayoutItemNestedControlCollection>
            </dx:LayoutItem>
    ...
    <dx:ASPxGridView ID="gvGerenciamentoLivros" runat="server" showInsert="True" AllowEditing="True" Width="100%" KeyFieldName="liv_id_livro"
        ...
        <Columns>
           ...
           <%-- <dx:GridViewDataTextColumn PropertiesTextEdit-MaxLength="15" FieldName="autor_id" Caption="Autor" /> --%> 
