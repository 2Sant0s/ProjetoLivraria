    ...
    public class LivroDAO
    {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        FROM LIV_LIVROS LIV
                         ...
                         JOIN TIL_TIPO_LIVRO TIL on LIV.LIV_ID_TIPO_LIVRO = TIL.TIL_ID_TIPO_LIVRO", ioConexao);
                    }
                    ...
                    using (SqlDataReader loReader = ioQuery.ExecuteReader())
                    {
                        while (loReader.Read())
                        {
                            ...
                            string nomeEditor = loReader.IsDBNull(7) ? "" : loReader.GetString(7);
                            int edicao = loReader.IsDBNull(8) ? 0 : loReader.GetInt32(8);
                            string nomeAutor = loReader.IsDBNull(9) ? "" : loReader.GetString(9);
                            string descricaoLivro = loReader.IsDBNull(10) ? "" : loReader.GetString(10);
        ...
        public int AtualizaLivro(Livro aoNovoLivro)
        {
            ...
            ", ioConexao);
                    ...
                    ioQuery.Parameters.Add(new SqlParameter("@tipoLivro", aoNovoLivro.liv_id_tipo_livro));  // Adicione esta linha
                    ioQuery.Parameters.Add(new SqlParameter("@idEditor", aoNovoLivro.liv_id_editor));
                }
                catch (Exception ex)
                {
