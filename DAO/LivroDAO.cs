    ...
    ", ioConexao);
            ...
            public int AtualizaLivro(Livro aoNovoLivro)
            {
                ...
                SET 
                    ...
                    LIV_ID_EDITOR = @idEditor,
                    LIV_NM_TITULO = @nomeTitulo,
                    LIV_VL_PRECO = @valorPreco,
                    LIV_PC_ROYALTY = @royalty,
                    LIV_DS_RESUMO = @resumo,
                    LIV_NU_EDICAO = @numeroEdicao
                WHERE LIV_ID_LIVRO = @idLivro;
            
                UPDATE LIA_LIVRO_AUTOR
                SET 
                    LIA_ID_AUTOR = @idAutor
                WHERE LIA_ID_LIVRO = @idLivro;
            ", ioConexao);

                        ioQuery.Parameters.AddWithValue("@idLivro", aoNovoLivro.liv_id_livro);
                        ioQuery.Parameters.AddWithValue("@idTipoLivro", aoNovoLivro.liv_id_tipo_livro);
                        ioQuery.Parameters.AddWithValue("@idEditor", aoNovoLivro.liv_id_editor);
                        ioQuery.Parameters.AddWithValue("@nomeTitulo", aoNovoLivro.liv_nm_titulo);
                        ioQuery.Parameters.AddWithValue("@valorPreco", aoNovoLivro.liv_vl_preco);
                        ioQuery.Parameters.AddWithValue("@royalty", aoNovoLivro.liv_pc_royalty);
                        ioQuery.Parameters.AddWithValue("@resumo", aoNovoLivro.liv_ds_resumo ?? string.Empty);
                        ioQuery.Parameters.AddWithValue("@numeroEdicao", aoNovoLivro.liv_nu_edicao);

                        ioQuery.Parameters.AddWithValue("@idAutor", aoNovoLivro.aut_id_autor);
